...
namespace Core.Network
{
	...
	public class Packet
	{
		...
		/// <summary>
		/// Resets packet to zero while setting a new op and id, without allocating a new buffer.
		/// </summary>
		...
		/// <summary>
		/// Adds one byte for type, 2 bytes for the length of the val bytes, and the vals itself to buffer.
		/// </summary>
		...
		/// <exception cref="InvalidOperationException">Thrown when val is not a struct.</exception>
		...
		/// <summary>
		/// Resizes buffer, if there's not enough space for the required amount of bytes.
		/// </summary>
		...
		/// <summary>
		/// Throws IndexOutOfRangeException, if buffer doesn't have the given amount of bytes left.
		/// </summary>
