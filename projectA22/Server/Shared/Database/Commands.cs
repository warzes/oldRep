...
namespace Shared.Database
{
	...
	/// <example>
	/// <code>
	/// using (var conn = SharedDb.Instance.Connection)
	...
	{
		public UpdateCommand(string command, MySqlConnection conn, MySqlTransaction trans = null) : base(command, conn, trans) { }
	...
	public class InsertCommand : SimpleCommand
	{
		...
		public InsertCommand(string command, MySqlConnection conn, MySqlTransaction transaction = null) : base(command, conn, transaction) { }
