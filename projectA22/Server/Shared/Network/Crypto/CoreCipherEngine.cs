...
{
	/// <summary>
	/// Implementation of custom cipher
	/// </summary>
	public sealed class CoreCipherEngine
	{
		private int _idx;

		private readonly byte[] _keystream;
		private readonly CoreKeystreamGenerator _keyGen;

		public CoreCipherEngine(CoreKeystreamGenerator keyGen)
		{
			_keyGen = keyGen;
