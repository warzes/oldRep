...
namespace Shared.Network
{
	public class ServerInfoManager
	{
		...
		/// <summary>
		/// Returns channel info from server or null, if server or channel doesn't exist.
		/// </summary>
		...
		/// <summary>
		/// Adds server with this name, if it doesn't exist already, and returns the new or existing server info for it.
		/// </summary>
		...
		/// <summary>
		/// Adds channel and server, if it doesn't exist yet. Replaces channel if it already exists.
		/// </summary>
