...
namespace Shared.Util
{
	public class CliUtil
	{
		...
		/// <summary>
		/// Writes line to Console, centering it either with the string's length or the given length as reference.
		/// </summary>
		...
		/// </summary>
		/// <remarks>
		/// Custom property wrapping Environment.UserInteractive, with special behavior for Mono, which currently doesn't support that property.
		/// </remarks>
